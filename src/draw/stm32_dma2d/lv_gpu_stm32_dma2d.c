...
static void lv_draw_stm32_dma2d_img_decoded(lv_layer_t * draw, const lv_draw_img_dsc_t * dsc,
...
void lv_draw_stm32_dma2d_ctx_init(lv_disp_t * disp, lv_layer_t * layer)
{

    lv_draw_sw_init_ctx(drv, layer);

    lv_draw_stm32_dma2d_ctx_t * dma2d_layer = (lv_draw_sw_ctx_t *)layer;

    dma2d_layer->blend = lv_draw_stm32_dma2d_blend;
    //    dma2d_layer->base_draw.draw_img_decoded = lv_draw_stm32_dma2d_img_decoded;
    dma2d_layer->base_draw.wait_for_finish = lv_gpu_stm32_dma2d_wait_cb;
    dma2d_layer->base_draw.buffer_copy = lv_draw_stm32_dma2d_buffer_copy;

}

void lv_draw_stm32_dma2d_ctx_deinit(lv_disp_t * disp, lv_layer_t * layer)
{
    LV_UNUSED(disp);
    LV_UNUSED(layer);
}
...
static void lv_draw_stm32_dma2d_img_decoded(lv_layer_t * layer, const lv_draw_img_dsc_t * dsc,
                                            const lv_area_t * coords, const uint8_t * map_p, lv_img_cf_t color_format)
{
